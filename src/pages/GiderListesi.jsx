    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div className="bg-white px-6 py-12 text-center">
          ...
          <p className="mt-4 text-gray-600">Henüz gider kaydı yok</p>
          <p className="text-sm text-gray-500 mt-1">Bu özellik yakında eklenecek</p>
        </div>
      </div>
        ...
        <div className="flex items-start">
          ...
          <div className="ml-3">
            ...
            <p className="mt-2 text-sm text-blue-700">
              Gider Listesi özelliği şu anda geliştirme aşamasındadır. Bu sayfada işletme giderlerinizi,
              harcamalarınızı ve masraflarınızı takip edebileceksiniz.
            </p>
          </div>
        </div>
      </div>
